...
const EducationSection: React.FC = () => {
  ...
  const educationData: EducationItem[] = [
    {
      id: 1,
      degree: "Bachelor of Computer Applications With Data Science",
      ...
      achievements: [
        ...
        "Created Mutlple Learning Projects",
        "Contributed in Techathons",
      ],
      courses: [
    ...
    },
    {
      ...
      gpa: "7/10",
      color: "#00C2FF",
      specialization: "Science (Phy, Chem, Maths)",
      achievements: [
        "Participated in Inter School level competitions.",
        "Created projects.",
      ],
      courses: [
        "Advanced Mathematics",
        "Advanced Concepts of Physics",
        "Advanced Concepts of Chemistry",
      ],
    },
    {
      id: 3,
